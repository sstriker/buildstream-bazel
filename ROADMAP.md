...
- **Complexity lens — soft-launched, drive to green then flip to blocking.**
  ...
  gocognit>50, nestif>10, funlen); the burndown is underway (**48** now — passes
  1-6 cleared `buildFindPackageAttrib` (51→14), `recoverSourceComments` (55→11), `lowerInterfaceLibraries` (60→15), `applyProbeGenexProperties`
