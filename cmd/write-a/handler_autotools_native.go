...
func (autotoolsHandler) RenderA(elem *element, elemPkg string) error {
	...
	// Trace-driven path: A-side is just a marker. The
	// install genrule + source tree live in project B.
	// (srckey debug artifacts land here once PR #62 merges
	// — for now keep A minimal so this PR is independently
	// reviewable.)
